...
export const CausalesNegocioContainer = () => {
	const dispatch = useAppDispatch()
	const { startLoading, stopLoading } = useLoading()

	// Selector de causales
	const { resource, getStatus } = useAppSelector(causalesNegocioSelector)
	...
	const handleConfirmDelete = () => {
		if (currentCausal) {
			...
			dispatch(
				deleteCausalNegocio({ codigoCausal: currentCausal.idCausal })
			).then(stopLoading)
